...
hi     Awesome WM configuration template
     github.com/lcpz
...
lain.layout.cascade.tile.nmaster       = 6
...
globalkeys = mytable.join(
    ...
    awful.key({ modkey, }, "z", function () awful.util.spawn("/home/qualia/.config/rofi/launchers/type-2/launcher.sh") end,
    ...
    -- Screen brightness
    awful.key({ }, "XF86MonBrightnessUp", function () os.execute("bright +") end,
              {description = "+10%", group = "hotkeys"}),
    awful.key({ }, "XF86MonBrightnessDown", function () os.execute("bright -") end,
              {description = "-10%", group = "hotkeys"}),
    ...
    awful.key({ altkey, "Control" }, "0",
        function ()
            os.execute("pactl -- set-sink-mute @DEFAULT_SINK@ 100%")  
        end,
