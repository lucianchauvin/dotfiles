...
theme.tasklist_maincolor		            	= "#83A598"
theme.taglist_squares_sel                       = theme.dir .. "/icons/square_sel.png"
theme.taglist_squares_unsel                     = theme.dir .. "/icons/square_unsel.png"
theme.tasklist_fg_focus				            = "#FB4934"
...
local cpu = lain.widget.cpu({
    settings = function()
        widget:set_markup(markup.font(theme.font, markup(theme.tasklist_maincolor, " cpu ") .. cpu_now.usage .. " "))
    end
})
...
local mem = lain.widget.mem({
    settings = function()
        widget:set_markup(markup.font(theme.font, markup(theme.tasklist_maincolor, " mem ") .. mem_now.used .. " "))
    end
})
...
local net = lain.widget.net({
    settings = function()
        widget:set_markup(markup.font(theme.font, markup(theme.tasklist_maincolor, " net ") .. net_now.received)
                          .. " " ..
...
local temp = lain.widget.temp({
    settings = function()
        widget:set_markup(markup.font(theme.font, markup(theme.tasklist_maincolor, " temp ") .. coretemp_now .. " "))
    end
})
...
local bat = lain.widget.bat({
    settings = function()
        ...
        widget:set_markup(markup.font(theme.font, markup(theme.tasklist_maincolor, " bat ") .. perc .. " "))
    end
})
